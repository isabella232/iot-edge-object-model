...
describe('$EdgeAgentConfigurationContentGenerator', () => {
    describe('generate$EdgeAgentConfigurationcContent', () => {
        it('generates object', () => {
            ...
            expect(result.systemModules.edgeHub.startupOrder).toEqual(7); // tslint:disable-line: no-magic-numbers
            ...
            expect(result.modules[vm.moduleSpecificationViewModels[0].name].startupOrder).toEqual(0);
        });
    });
